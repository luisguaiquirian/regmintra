<?
    $system->sql = "SELECT *, 
                    ...
                    from users where perfil = 4 and users.estado =".$_SESSION['edo']." AND users.municipio=".$_SESSION['mun'];
$sql = $system->sql();
    ...
    <div class="modal-dialog" style="width: 80%;">
        ...
        <div class="modal-content">
            <div class="modal-header login-header" style="background-color: black; color: white;">
                ...
                <h4 class="modal-title">Linea Transporte del municipio <?= $sql[0]->municipio_nombre  ?></h4>
            </div>
