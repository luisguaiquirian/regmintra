<?
    $system->sql = "
                  ...
                  INNER JOIN cauchos as t8 ON t8.id = t2.num_neu
                   where t1.perfil = 5 and t2.estado=".$_SESSION['edo']." and t2.municipio=".$_SESSION['mun'];
    ...
    <div class="modal-dialog" style="width: 80%;">
        ...
        <div class="modal-content">
            <div class="modal-header login-header" style="background-color: black; color: white;">
                ...
                <h4 class="modal-title">Unidades Activas de municipio <?= $sql[0]->municipio_nombre ?></h4>
            </div>
