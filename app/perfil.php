...
-->
                                        ...
                                        <form name="foto_perfil" method="post" action="./usuario/operacion_foto.php" enctype="multipart/form-data">
							...
							<div class="tabs">
								...
								<div class="tab-content">
									<div id="edit" class="tab-pane active">
										...
										<form name="perfil" class="form-horizontal" method="post" action="usuario/operaciones.php">
...
<script>
        $('#form_password_reset').submit(function(e) {
            ...
            $.ajax({
                    url: '<?= $_SESSION["base_url1"]."app/usuario/operaciones.php" ?>',
                    type: 'POST',
                    dataType: 'JSON',
                    data: $(this).serialize(),
                })
