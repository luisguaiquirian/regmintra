<?php
	...
	$mysqli = new mysqli("localhost", "root", "mtnl", "regmintra2");
	...
	if (mysqli_connect_errno()) {
		...
		$consulta = "SELECT * FROM users where usuario = $u and (perfil>3 or perfil <5)";
    		...
    		<div class="panel panel-default" style="box-shadow: 3px 3px 3px rgb(127, 140, 141)">
			  <div class="panel-body">
				<div class=" col-xs-12 col-md-4 text-center">
					<img src="<?= $_SESSION['base_url1'].'assets/images/fotos/'.$obj->foto ?>" class="rounded img-responsive text-center" height="100%" width="100%" alt="Foto">
				...
				<div class="col-xs-12 col-md-8">
					...
					<div class="col-xs-12"><strong><span class="glyphicon glyphicon-modal-window text-danger" aria-hidden="true"></span> Cédula:</strong> <?= $obj->nacionalidad." - ".$obj->cedula ?>.</div>
					<br><br>
					...
					<div class="col-xs-12"><strong><span class="glyphicon glyphicon-phone-alt text-danger" aria-hidden="true"></span> Teléfono:</strong> <?= $obj->telefono ?>.</div>
					<br><br>
