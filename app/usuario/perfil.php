...
<!--														<button type="reset" class="btn btn-default">Reset</button>-->
									...
									<div id="carnet" class="tab-pane">
                                        ...
                                        <a class="btn btn-primary btn-lg text-center" href="<?php echo $_SESSION['base_url1'].'app/gen_carnet.php?u='.base64_encode($_SESSION['user_id'])?>"  target="_blank" role="button">Generar Carnet&nbsp;<i class="fa fa-credit-card"></i></a>		<h4 class="mb-md">Ver Código QR</h4>
                                        <a class="btn btn-primary btn-lg text-center mb-xs mt-xs mr-xs modal-with-zoom-anim btn btn-default" href="#modalAnim">Ver QR&nbsp;<i class="fa fa-qrcode"></i></a>
											...
											<div class="panel-body">
												<div class="modal-wrapper">
													<div class="text-center">
														<p><img src="<?= $_SESSION['base_url1'].$register[0]->qr ?>"> </p>
													</div>
												</div>
											</div>
