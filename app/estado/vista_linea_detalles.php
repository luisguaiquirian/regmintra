				...
				<fieldset>
                   ...
                   <div class="form-group">
						<div class="col-md-4 col-sm-4 col-md-offset-4">
                            <a href="vista_lineas_gen.php?id=<?= base64_encode($register->estado) ?>&id_mun=<?= base64_encode($register->municipio) ?>"><button type="button" class="btn btn-info btn-block">Volver&nbsp;<i class="fa fa-send"></i></button></a>
						</div>
					</div>
				</fieldset>
			</form>
