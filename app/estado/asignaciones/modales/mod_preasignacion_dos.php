<div id="modal_preasignacion_dos" data-backdrop="static" data-keyboard="false" class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" style="overflow-y: scroll;">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <strong><h4>Producto en cuota: <span class="descripcion_asig text-danger"></span>.</h4></strong> 
        <strong><h4>Disponibilidad: <span class="descripcion_asig_can text-danger"></span>.</h4></strong>
        <strong><h4>Producto Solicitado: <span class="descripcion_productoref text-danger"></span>.</h4></strong>
        <hr>
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-danger" onclick="preasignar();"><span class="glyphicon glyphicon-floppy-saved" aria-hidden="true"></span>&nbsp;Preasignar</button>
      </div>
    </div>
  </div>
</div>