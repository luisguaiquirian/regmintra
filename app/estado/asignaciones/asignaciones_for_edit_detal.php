  ...
  <section class="panel panel-featured panel-featured-success">
    <header class="panel-heading">
      ...
      <div class="panel-body">
        ...
        <h5>Precio unitario:<strong id="ver_precio"><?= $r[0]->precio;?></strong>&nbsp;</h5>
      ...
      <div class="btn-group" role="group" aria-label="...">
        <a data-tool="tooltip" title="Volver a la lista de solicitudes por confirmar" class="btn btn-default" href="<?= $_SESSION['base_url1'].'app/estado/asignaciones/asignaciones_for_edit.php' ?>" role="button">Volver</a>
        ...
        <button onclick="confirmar_preasignacion(<?= $r[0]->id;?>);" data-tool="tooltip" title="Enviar la preasignacion para confirmacion por parte del Ministerio" type="button" class="btn btn-default">Modificar</button>
      </div>
  </section>
        
<?
  include_once $_SESSION['base_url'].'app/estado/asignaciones/modales/modal_carga.php';
  include_once $_SESSION['base_url'].'app/estado/asignaciones/modales/confirmacion/modal_observacion.php';
  include_once $_SESSION['base_url'].'app/estado/asignaciones/modales/confirmacion/modal_agregar_unidad.php';
  include_once $_SESSION['base_url'].'app/estado/asignaciones/modales/confirmacion/modal_info.php';
  include_once $_SESSION['base_url'].'app/estado/asignaciones/modales/confirmacion/modal_cambio_precio.php';
  include_once $_SESSION['base_url'].'app/estado/asignaciones/modales/confirmacion/modal_cancelar_asignacion.php';
...
<script type="text/javascript">
  ...
  function confirmar_preasignacion(id){
    alertify.confirm('Regmintra','¿Seguro quiere confirmar la modificación de la preasignacion?',function(){
      
      $.getJSON('../operaciones.php',{
        key:btoa(id),
        action: 'confirmar_modificacion_preasignacion'
      }, function(data){  
          if(data.msg){
            $("#modal_carga").modal('hide');
            toastr.success(data.msj);
