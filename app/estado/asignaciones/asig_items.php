...
$con1="select b.descripcion,COUNT(*) as cantidad,b.id as rubro
FROM
detalles_solicitudes AS a
  ...
  function traer(tipo){
    ...
    $.getJSON('./operaciones.php',{
      ...
      if (data.msj) {
        ...
        $("#total_p").html('Total de '+sum+' unidades de '+data.con[0].descripcion+' solicitados en el Estado <?php echo $_SESSION['estado']?>.');
