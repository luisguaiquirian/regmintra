...
where users.estado =".$_SESSION['edo'];
  
	$title ="Usuarios del Sistema";
                        
	$th = ['Municipio','nombre de usuario','perfil','cédula','nombre','apellido','teléfono'];
	$key_body = ['municipio','usuario','nomperfil','cedula','nombre','apellido','telefono'];
	$data = $system->sql();
